                        ...
                        <div class="row g-0">
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form>
                                        ...
                                        <div class="text-center pt-1 mb-2 pb-2">
                                            <button id="loginBtn"
                                                class="mx-2 btn btn-primary btn-block fa-lg gradient-custom-2 w-100"
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="small mb-0">Somos tu aliado de confianza en el mantenimiento y cuidado de
                                        vehículos. Con más de [X] años de experiencia en el mercado,
                                        ofrecemos una amplia gama de repuestos originales y de alta calidad para todo
                                        tipo de automóviles.</p>
                                </div>
                            </div>
                        </div>
                    </div>
